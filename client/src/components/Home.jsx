    ...
    <div>
      ...
      <div className='bg-white mx-3 p-4 mb-12' >
        ...
        <div className="grid grid-cols-4 gap-4 ">
          <div>
            <img className="border-4 border-yellow-800" src={kenia}/>
          </div>
          <div>
            <img className="border-4 border-yellow-800" src={ilvea}/>
          </div>
          <div>
            <img className="border-4 border-yellow-800" src={yexenia}/>
          </div>
          <div>
            <img className="border-4 border-yellow-800" src={adela}/>
          </div>
        </div>
      </div>
    </div>
